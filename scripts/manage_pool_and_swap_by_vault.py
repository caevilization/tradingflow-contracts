...
def main():
    ...
    token_a_address = tx_receipt.contractAddress
    ...
    tx_receipt = w3.eth.wait_for_transaction_receipt(tx_hash)
    token_b_address = tx_receipt.contractAddress
    ...
    Vault_bytecode = get_contract_bytecode(BASE_PATH / "artifacts/contracts/UniswapVault.sol/OracleGuidedVault.json")
